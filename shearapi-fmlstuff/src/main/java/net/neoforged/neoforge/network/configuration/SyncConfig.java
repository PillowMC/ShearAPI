...
public record SyncConfig(ServerConfigurationPacketListener listener) implements ICustomConfigurationTask {
    private static final ResourceLocation ID = new ResourceLocation(ShearAPIRuntime.MOD_ID, "sync_config");
    public static Type TYPE = new Type(ID.toString()); // TODO: (ShearAPI) Type(ResourceLocation) constructor
