...
public class NetworkRegistry {
    ...
    public void setup() {
        ...
        ShearAPIRuntime.getRuntime().postModBusEvent(new RegisterPayloadHandlerEvent(namespace -> registrarsByNamespace.computeIfAbsent(namespace, ModdedPacketRegistrar::new)));
