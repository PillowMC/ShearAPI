...
//    }
    ...
    public static void postNewRegistryEvent() {
        ...
        ShearAPIRuntime.getRuntime().postModBusEventWrapContainerInModOrder(dataPackEvent);

        event.fill();
        dataPackEvent.process();

        ShearAPIRuntime.getRuntime().postModBusEventWrapContainerInModOrder(new ModifyRegistriesEvent());
